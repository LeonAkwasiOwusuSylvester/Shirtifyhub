...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        if ($stmt->execute([$email, $hashedPassword])) {
            ...
            // Set the unified master sessions
            $_SESSION['temp_user_id'] = $userId;
            $_SESSION['pending_otp']  = $otp;
            $_SESSION['auth_flow']    = 'register'; // Tells verify-otp where to go next
            
            // Send the Welcome/Verification Email
            if(file_exists(__DIR__ . "/helpers/mailer.php")) {
                require_once __DIR__ . "/helpers/mailer.php";
                $subject = "Welcome to Shirtifyhub - Verify Account";
                $title   = "Verify Your Email";
                $message = "Welcome to the club! Your registration code is: <h2 style='text-align:center; letter-spacing: 5px; color: #0f172a; padding: 20px; background: #f1f5f9; border-radius: 10px; margin: 20px 0;'>$otp</h2>Please enter this code on the verification screen to activate your account.";
...
<div class="auth-container">
    <div class="auth-card">
        <div class="text-center mb-4">
            ...
            <p class="text-muted small">Join us and start shopping premium fashion.</p>
        </div>
        ...
        <form action="register.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="custom-input-group">
                    ...
                    <input type="password" name="password" id="passwordInput1" class="form-control" placeholder="••••••••" required>
            ...
            <button type="submit" class="btn btn-brand mb-4">Create Account</button>
            
            <div class="text-center pt-3 border-top">
                <span class="text-muted small fw-bold">Already have an account?</span> 
                <a href="login.php" class="text-decoration-none small fw-bold ms-1" style="color: var(--brand-blue);">Sign In here</a>
            </div>
        </form>
    </div>
</div>
